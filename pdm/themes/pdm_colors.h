...
#ifndef PDM_PLATFORMS_UI_PDM_COLORS_H
#define PDM_PLATFORMS_UI_PDM_COLORS_H
namespace PDM::THEME::COLOR::Light  {
...
namespace PDM::THEME::COLOR::Dark{
  namespace { // Unnamed namespace, since we only use this here.
    unsigned int Color(unsigned int c) {
      // add alpha.
      // also swap red and blue channel for some reason.
...
#endif //PDM_PLATFORMS_UI_PDM_COLORS_H
